...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\DSTRA
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\DSTRA
    // Mac: ~/Library/Application Support/DSTRA
    // Unix: ~/.dstra
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "DSTRA";
#else
    fs::path pathRet;
